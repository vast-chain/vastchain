...
use vast_crypto::publickey::{Generator, KeyPair, Public, Random, recover, Secret, sign, ecdh, ecies};
use network::Error;
...
/// `RLPx` protocol handshake. See https://github.com/vast/devp2p/blob/master/rlpx.md#encrypted-handshake
...
mod test {
	...
	use vastcore_io::*;
	use vast_crypto::publickey::Public;
