...
use vast_crypto::aes::{AesCtr256, AesEcb256};
use vast_crypto::publickey::Secret;
use vast_types::{H128, H256, H512};
...
use vastcore_io::{IoContext, StreamToken};
use network::Error;
...
/// https://github.com/vast/devp2p/blob/master/rlpx.md#framing
...
impl EncryptedConnection {
	...
	pub fn new(handshake: &mut Handshake) -> Result<EncryptedConnection, Error> {
		let shared = vast_crypto::publickey::ecdh::agree(handshake.ecdhe.secret(), &handshake.remote_ephemeral)?;
