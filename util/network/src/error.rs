...
pub enum Error {
	...
	#[display(fmt = "Too many open files in this process. Check your resource limits and restart vast")]
	ProcessTooManyFiles,
	/// Reached system wide resource limits
	#[display(fmt = "Too many open files on system. Consider closing some processes/release some file handlers or increas the system-wide resource limits and restart vast.")]
	SystemTooManyFiles,
