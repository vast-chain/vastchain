...
impl<T: Len + ?Sized> LenCachingRwLock<T> {
	...
	/// [`write()`](../../lock_api/struct.RwLock.html#mvastod.write).
	...
	/// Delegates to `parking_lot::RwLock`
	/// [`try_write()`](../../lock_api/struct.RwLock.html#mvastod.try_write).
	...
	/// Delegates to `parking_lot::RwLock`
	/// [`read()`](../../lock_api/struct.RwLock.html#mvastod.read).
	pub fn read(&self) -> RwLockReadGuard<T> {
		self.data.read()
	}

	/// Delegates to `parking_lot::RwLock`
	/// [`try_read()`](../../lock_api/struct.RwLock.html#mvastod.try_read).
