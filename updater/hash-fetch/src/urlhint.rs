...
pub mod tests {
	...
	fn should_decode_urlhint_content_output() {
		...
		assert_eq!(res, Some(URLHintResult::Content(Content {
			url: "https://vast.io/assets/images/vastcore-black-horizontal.png".into(),
			mime: mime::IMAGE_PNG,
			owner: Address::from_str("deadcafebeefbeefcafedeaddeedfeedffffffff").unwrap(),
		})))
	}
	...
	fn should_guess_mime_type_from_url() {
		let url1 = "https://vast.io/vast";
		let url2 = "https://vast.io/vast#content-type=image/png";
		let url3 = "https://vast.io/vast#somvasting&content-type=image/png";
		let url4 = "https://vast.io/vast.png#content-type=image/jpeg";
		let url5 = "https://vast.io/vast.png";
