...
use common_types::{
	...
	errors::{VastcoreError as Error, SnapshotError, SnapshotError::UnlinkedAncientBlockChain},
	ids::BlockId,
...
impl<C> Service<C> where C: SnapshotClient + ChainInfo {
	...
	/// The recover flag indicates whvaster to recover the restored snapshot.
	...
	/// Import a previous chunk at the given path. Returns whvaster the chunk was imported or not
