...
use vast_types::{Address, H256, H64};
use bytes::Bytes;
use vastjson;
use rlp::Rlp;
use unexpected::Mismatch;

use crate::{BlockNumber, errors::{BlockError, VastcoreError}};
...
/// Vastash/Clique specific seal
#[derive(Debug, PartialEq)]
pub struct VastashSeal {
	/// Vastash seal mix_hash
	pub mix_hash: H256,
	/// Vastash seal nonce
	pub nonce: H64,
}
...
impl VastashSeal {
	/// Tries to parse rlp encoded bytes as an Vastash/Clique seal.
	pub fn parse_seal<T: AsRef<[u8]>>(seal: &[T]) -> Result<Self, VastcoreError> {
		if seal.len() != 2 {
...
/// As defined in https://github.com/vast/EIPs/pull/210
...
/// Vastash-specific extensions.
#[derive(Debug, Clone)]
pub struct VastashExtensions {
...
impl From<vastjson::spec::VastashParams> for VastashExtensions {
