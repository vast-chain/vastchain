...
use vast_types::{Address, U256, H256};
use bytes::Bytes;
use vastjson;
...
/// Parameters common to vast-like blockchains.
...
pub struct CommonParams {
	...
	/// Number of first block where EIP-1344 rules begin: https://github.com/vast/EIPs/blob/master/EIPS/eip-1344.md
	pub eip1344_transition: BlockNumber,
	/// Number of first block where EIP-1884 rules begin:https://github.com/vast/EIPs/blob/master/EIPS/eip-1884.md
...
impl CommonParams {
	/// Schedule for an EVM in the post-EIP-150-era of the Vast main net.
...
impl From<vastjson::spec::Params> for CommonParams {
	fn from(p: vastjson::spec::Params) -> Self {
		CommonParams {
			...
			subprotocol_name: p.subprotocol_name.unwrap_or_else(|| "vast".to_owned()),
