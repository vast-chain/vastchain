...
use vast_types::{U256, H256};
use security_level::SecurityLevel;
use BlockNumber;

/// Information about the blockchain gathered togvaster.
#[derive(Clone, Debug)]
...
impl BlockChainInfo {
	...
	pub fn security_level(&self) -> SecurityLevel {
		// TODO: Detect SecurityLevel::FullState : https://github.com/vasttech/vast-vast/issues/3834
