...
pub struct ExtendedHeader {
	/// The actual header.
	pub header: Header,
	/// Whvaster the block underlying this header is considered finalized.
...
impl ExtendedHeader {
	/// Returns combined difficulty of all ancestors togvaster with the difficulty of this header.
...
mod tests {
	...
	fn test_header_seal_fields() {
		// that's rlp of block header created with vastash engine.
