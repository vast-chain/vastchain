...
//!
//! This crate stores Vast Vasterem specific types that are
...
//! Don't treat this crate as a bag for any types that we use in Vast.
//! This one is reserved for types that are shared heavily (like transactions),
//! historically this contains types extracted from `vastcore` crate, if possible
...
extern crate vast_util_mem as malloc_size_of;
