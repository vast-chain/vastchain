...
use vast_types::{H256, U256, U512, Address};
use keccak_hash::keccak;
use vast_bytes::{Bytes, BytesRef};
use rlp::RlpStream;
use log::trace;
...
impl<'a, B: 'a + StateBackend> Executive<'a, B> {
	...
	pub fn call_with_crossbeam<T, V>(
		...
		let local_stack_size = vastcore_io::LOCAL_STACK_SIZE.with(|sz| sz.get());
...
mod tests {
	...
	use vast_types::{H256, U256, U512, Address, BigEndianHash};
	...
	use vastcore::test_helpers::{get_temp_state_with_factory, get_temp_state};
	...
	fn test_call_to_create() {
		...
		let expected_trace = vec![FlatTrace {
			...
			action: trace::Action::Create(trace::Create {
				...
				creation_mvastod: Some(trace::CreationMvastod::Create),
			}),
