...
fn single_builtin_pricing() -> Machine {
	test_helpers::load_machine(include_bytes!("../../res/vast/builtin_one_activation_bench.json"))
}

fn multiple_builtin_pricing() -> Machine {
	test_helpers::load_machine(include_bytes!("../../res/vast/builtin_multi_bench.json"))
}
