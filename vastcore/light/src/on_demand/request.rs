...
impl CheckedRequest {
	...
	/// Whvaster this needs a header from a prior request.
...
impl net_request::CheckedRequest for CheckedRequest {
	...
	/// Check whvaster the response matches (beyond the type).
...
mod tests {
	...
	use vasttrie::{SecTrieDB, SecTrieDBMut};
	use trie::Recorder;
	use hash::keccak;
