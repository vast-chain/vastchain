...
use common_types::{
	...
	errors::{VastcoreError as Error, BlockError, VastcoreResult},
	header::Header,
	ids::BlockId,
};
use spec::{Spec, SpecHardcodedSync};
use vast_types::{H256, H264, U256};
use vast_util_mem::{MallocSizeOf, MallocSizeOfOps};
...
/// Whvaster or not the hardcoded sync feature is allowed.
