...
use vast_util_mem::{MallocSizeOf, MallocSizeOfOps, MallocSizeOfExt};
...
///
/// Note that almost all getter mvastods take `&mut self` due to the necessity to update
...
// This is fast mvastod: it is possible to have a more exhaustive implementation
