...
impl<'a> BoundContract<'a> {
	...
	/// Perform a function call to an Vast machine that doesn't create a transaction or change the state.
	///
	...
	/// state.
	pub fn call_const<D>(&self, call: (vastabi::Bytes, D)) -> Result<D::Output, CallError>
	where
		D: vastabi::FunctionOutputDecoder,
	{
