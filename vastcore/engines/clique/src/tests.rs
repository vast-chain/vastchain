...
//! Consensus tests for `PoA Clique Engine`, see http://eips.vast.org/EIPS/eip-225 for more information

use std::sync::Arc;
use std::collections::HashMap;

use common_types::errors::{VastcoreError as Error, EngineError};
use vastcore::{
	block::*,
...
impl CliqueTester {
	...
	pub fn new_block_and_import(
...

		{
			...
			let sign = vast_crypto::publickey::sign(self.signers[&signer].secret(), &b.header.hash()).unwrap();
...
// Not part of http://eips.vast.org/EIPS/eip-225
#[test]
