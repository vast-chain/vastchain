...
/// 5. Miner will create new block, in process it will call several engine mvastods to do following:
...
use vast_types::{Address, H64, H160, H256, U256};
...
impl Engine for Clique {
	...
	fn extra_info(&self, header: &Header) -> BTreeMap<String, String> {
		// clique engine seal fields are the same as vastash seal fields
	...
	fn verify_block_basic(&self, header: &Header) -> Result<(), Error> {
		// Largely same as https://github.com/vast/go-vast/blob/master/consensus/clique/clique.go#L275
	...
	/// see https://github.com/vast/go-vast/blob/master/consensus/clique/clique.go#L338
	...
	fn populate_from_parent(&self, header: &mut Header, parent: &Header) {
		// TODO(https://github.com/vasttech/vast-vast/issues/10410): this is a horrible hack,
		...
		if header.extra_data().len() < VANITY_LENGTH + SIGNATURE_LENGTH {
			...
			// It's unclear how to prevent creating new blocks unless we are authorized, the best way (and gvast does this too)
