...
use spec::Genesis;
use vastjson::test_helpers::blockchain;
use miner::Miner;
use io::IoChannel;
	...
	for (name, blockchain) in tests.into_iter() {
		...
		let mut fail = false;
		{
...

			{
				...
				if vastjson::test_helpers::blockchain::Engine::NoProof == blockchain.engine {
...
mod block_tests {
	...
	//Issue: https://github.com/vasttech/vast-vast/issues/11085
	...
	//  Ignored in currents.json, issue: https://github.com/vasttech/vast-vast/issues/11073
