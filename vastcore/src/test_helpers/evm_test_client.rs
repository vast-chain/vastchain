...
pub enum EvmTestError {
	...
	Trie(Box<vasttrie::TrieError>),
	/// EVM error.
	Evm(vm::Error),
	/// Initialization error.
	ClientError(VastcoreError),
	/// Post-condition failure,
	PostCondition(String),
}

impl<E: Into<VastcoreError>> From<E> for EvmTestError {
	fn from(err: E) -> Self {
...
impl<'a> EvmTestClient<'a> {
	...
	fn factories(trie_spec: trie::TrieSpec) -> Factories {
		Factories {
			...
			trie: trie::TrieFactory::new(trie_spec, vasttrie::Layout),
	...
	pub fn transact<T: trace::Tracer, V: trace::VMTracer>(
		...
		// miner reward.
		// Details: https://github.com/vasttech/vast-vast/issues/9431
