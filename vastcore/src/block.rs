...
impl<'x> OpenBlock<'x> {
	...
	///
	/// If valid, it will be executed, and archived togvaster with the receipt.
...
impl LockedBlock {
	...
	/// TODO(https://github.com/vasttech/vast-vast/issues/10407): This is currently only used in POW chain call paths, we should really merge it with seal() above.
	pub fn try_seal(
		self,
		engine: &dyn Engine,
		seal: Vec<Bytes>,
