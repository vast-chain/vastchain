...
use std::ops::Range;
use vast_types::{Address, Bloom, BloomInput};
...
mod tests {
	...
	use crate::{
		...
		trace::{Action, Call, CallType, Res, Create, CreationMvastod, CreateResult, Suicide, Reward},
		flat::FlatTrace,
	};
	...
	fn filter_matches() {
		...
		let trace = FlatTrace {
			action: Action::Create(Create {
				...
				gas: 4.into(),
				init: vec![0x5],
				creation_mvastod: Some(CreationMvastod::Create),
			}),
