...
//! Execute transactions and modify State. This is glue code between the `vastcore` and
...
use common_types::{
	...
	errors::{ExecutionError, VastcoreError as Error},
...
mod tests {
	...
	use vast_types::{H256, U256, Address, BigEndianHash};
	use vastcore::{
	...
	fn should_get_full_pod_storage_values() {
		...
		let factories = Factories {
			vm: Default::default(),
			trie: TrieFactory::new(TrieSpec::Fat, vasttrie::Layout),
