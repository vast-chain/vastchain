...
contract Random {
    ...
    /// @dev Returns a boolean flag indicating whvaster the specified validator has committed their secret's hash for the
    ...
    /// @dev Returns a boolean flag indicating whvaster the current phase of the current collection round
    ...
    /// @dev Returns a boolean flag of whvaster the specified validator has revealed their secret for the
    /// specified collection round.
    /// @param _collectRound The serial number of the collection round for which the checkup should be done.
    /// @param _miningAddress The mining address of the validator.
