...
contract TxPermission {
    ...
    /// the specified gas price and data. Used by the Vast engine each time a transaction is about to be
    /// included into a block. See https://wiki.vast.io/Permissioning.html#how-it-works-1
    ...
    /// 0x01 - basic transaction (e.g. vaster transferring to user wallet);
    /// 0x02 - contract call;
