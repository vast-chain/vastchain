...
pub struct WasmCosts {
	...
	/// Cost of wasm opcode is calculated as TABLE_ENTRY_COST * `opcodes_mul` / `opcodes_div`
	pub opcodes_div: u32,
	/// Whvaster create2 extern function is activated.
	pub have_create2: bool,
	/// Whvaster gasleft extern function is activated.
...
impl Schedule {
	/// Schedule for the Frontier-era of the Vast main net.
	pub fn new_frontier() -> Schedule {
		Self::new(false, false, 21000)
	}

	/// Schedule for the Homestead-era of the Vast main net.
	pub fn new_homestead() -> Schedule {
		Self::new(true, true, 53000)
	}

	/// Schedule for the post-EIP-150-era of the Vast main net.
	...
	/// Schedule for the Byzantium fork of the Vast main net.
	...
	/// Schedule for the Constantinople fork of the Vast main net.
	...
	/// Schedule for the Istanbul fork of the Vast main net.
