...
impl From<vastjson::vm::Env> for EnvInfo {
	fn from(e: vastjson::vm::Env) -> Self {
...
mod tests {
	...
	fn it_serializes_from_json() {
		let env_info = EnvInfo::from(vastjson::vm::Env {
			author: vastjson::hash::Address(Address::from_str("000000f00000000f000000000000f00000000f00").unwrap()),
			number: vastjson::uint::Uint(U256::from(1_112_339)),
			difficulty: vastjson::uint::Uint(U256::from(50_000)),
			gas_limit: vastjson::uint::Uint(U256::from(40_000)),
			timestamp: vastjson::uint::Uint(U256::from(1_100))
		});
