...
use super::{Vastash, BasicAuthority, AuthorityRound, NullEngine, InstantSeal, Clique};
...
mod tests {
	...
	fn engine_deserialization() {
		...
		let deserialized: Engine = serde_json::from_str(s).unwrap();
		match deserialized {
			Engine::Vastash(_) => {},	// vastash is unit tested in its own file.
			_ => panic!(),
		};
