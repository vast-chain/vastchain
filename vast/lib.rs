...
extern crate vastcore_light as light;
extern crate vastcore_logger;
extern crate vastcore_miner as miner;
extern crate vastcore_network as network;
extern crate vastcore_private_tx;
extern crate vastcore_service;
...
extern crate vast_ipfs_api;
extern crate vast_local_store as local_store;
extern crate vast_path as path;
extern crate vast_rpc;
extern crate vast_runtime;
extern crate vast_updater as updater;
extern crate vast_version;
...
#[cfg(feature = "vastcore-accounts")]
extern crate vastcore_accounts as accounts;

#[cfg(feature = "secretstore")]
extern crate vastcore_secretstore;
...
pub use vast_rpc::PubSubSession;
pub use vastcore_logger::{Config as LoggerConfig, setup_log, RotatingLogger};
...
/// Action that Vast performed when running `start`.
...
///
/// The first parameter is the command line arguments that you would pass when running the vast
/// binary.
///
/// On error, returns what to print on stderr.
// FIXME: totally independent logging capability, see https://github.com/vasttech/vast-vast/issues/10252
pub fn start<Cr, Rr>(
	conf: Configuration,
	logger: Arc<RotatingLogger>,
	on_client_rq: Cr,
