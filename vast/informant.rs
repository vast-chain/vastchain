...
use vast_rpc::is_major_importing_or_waiting;
use vast_rpc::informant::RpcStats;
use vast_types::H256;
...
/// Somvasting which can provide data to the informant.
pub trait InformantData: Send + Sync {
	/// Whvaster it executes transactions
	fn executes_transactions(&self) -> bool;

	/// Whvaster it is currently importing (also included in `Report`)
