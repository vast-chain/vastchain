...
pub fn import_account(cmd: &ImportWallet, kp: vast_crypto::publickey::KeyPair, password: Password) {
	...
	let secret_store = Box::new(VastStore::open_with_iterations(dir, cmd.iterations).unwrap());
...
pub fn import_account(_cmd: &ImportWallet, _kp: vast_crypto::publickey::KeyPair, _password: Password) {}
