...
//! ProgPoW (Programmatic Proof-of-Work) is the Vast network's proposed new Application-Specific Integrated
...
//!
//! It would be a change from Vast's current PoW mining algorithm known as Vastash.
//!
//! ProgPoW audits have been proposed to analyse the efficiency of a ProgPoW ASICs over
//! GPUs and analysis of the economic impact on the Vast protocol.
//!
//! We use ProgPoW 0.9.3 version as suggested on Specification
//! https://github.com/vast/EIPs/blob/master/EIPS/eip-1057.md#specification

use compute::{FNV_PRIME, calculate_dag_item};
use keccak::H256;
use shared::{VASTASH_ACCESSES, VASTASH_MIX_BYTES, Node, get_data_size};
...
const PROGPOW_CNT_DAG: usize = VASTASH_ACCESSES;
const PROGPOW_DAG_LOADS: usize = 4;
const PROGPOW_MIX_BYTES: usize = 2 * VASTASH_MIX_BYTES;
