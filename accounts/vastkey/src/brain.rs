...
use vast_crypto::publickey::{KeyPair, Generator, Secret};
use vast_crypto::Keccak256;
use vast_wordlist;
...
impl Brain {
	...
	pub fn validate_phrase(phrase: &str, expected_words: usize) -> Result<(), ::WordlistError> {
		vast_wordlist::validate_phrase(phrase, expected_words)
	}
}
...
mod tests {
	use Brain;
	use vast_crypto::publickey::Generator;
