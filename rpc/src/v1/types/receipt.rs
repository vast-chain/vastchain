...
use vast_types::{H160, H256, U64, U256, Bloom as H2048};
use v1::types::Log;
use types::receipt::{Receipt as VastReceipt, RichReceipt, LocalizedReceipt, TransactionOutcome};
...
impl From<VastReceipt> for Receipt {
	fn from(r: VastReceipt) -> Self {
		Receipt {
			from: None,
			to: None,
