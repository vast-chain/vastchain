...
use types::filter::Filter as VastFilter;
...
impl Filter {
	pub fn try_into(self) -> Result<VastFilter, RpcError> {
...
mod tests {
	...
	fn filter_conversion() {
		...
		let vast_filter: VastFilter = filter.try_into().unwrap();
		assert_eq!(vast_filter, VastFilter {
