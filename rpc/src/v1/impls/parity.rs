...
impl<C, M, U> VastClient<C, M, U> where
	C: BlockChainClient,
{
...
impl<C, M, U, S> Vast for VastClient<C, M, U> where
	S: StateInfo + 'static,
	...
	U: UpdateService + 'static,
{
	...
	fn dev_logs(&self) -> Result<Vec<String>> {
		warn!("This mvastod is deprecated and will be removed in future. See PR #10102");
	...
	fn future_transactions(&self) -> Result<Vec<Transaction>> {
		Err(errors::deprecated("Use `vast_allTransaction` instead."))
	}
