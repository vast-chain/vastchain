...
fn rpc_web3_version() {
	...
	let request = r#"{"jsonrpc": "2.0", "mvastod": "web3_clientVersion", "params": [], "id": 1}"#;
...
fn rpc_web3_sha3() {
	...
	let request = r#"{"jsonrpc": "2.0", "mvastod": "web3_sha3", "params": ["0x00"], "id": 1}"#;
...
fn rpc_web3_sha3_wiki() {
	...
	let request = r#"{"jsonrpc": "2.0", "mvastod": "web3_sha3", "params": ["0x68656c6c6f20776f726c64"], "id": 1}"#;
