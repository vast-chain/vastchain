...
fn rpc_net_version() {
	...
	let request = r#"{"jsonrpc": "2.0", "mvastod": "net_version", "params": [], "id": 1}"#;
...
fn rpc_net_peer_count() {
	...
	let request = r#"{"jsonrpc": "2.0", "mvastod": "net_peerCount", "params": [], "id": 1}"#;
...
fn rpc_net_listening() {
	...
	let request = r#"{"jsonrpc": "2.0", "mvastod": "net_listening", "params": [], "id": 1}"#;
