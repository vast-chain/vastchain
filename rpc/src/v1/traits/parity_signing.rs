...
/// Signing mvastods implementation.
#[rpc(server)]
pub trait VastSigning {
	...
	#[rpc(meta, name = "vast_postTransaction")]
	...
	#[rpc(meta, name = "vast_decryptMessage")]
