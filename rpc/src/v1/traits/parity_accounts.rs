...
//! Vast Accounts-related rpc interface.
...
/// Vast-specific read-only accounts rpc interface.
#[rpc(server)]
pub trait VastAccountsInfo {
	/// Returns accounts information.
	#[rpc(name = "vast_accountsInfo")]
	fn accounts_info(&self) -> Result<BTreeMap<H160, AccountInfo>>;

	/// Returns default account for dapp.
	#[rpc(name = "vast_defaultAccount")]
	fn default_account(&self) -> Result<H160>;
}

/// Personal Vast rpc interface.
#[rpc(server)]
pub trait VastAccounts {
	/// Returns accounts information.
	#[rpc(name = "vast_allAccountsInfo")]
	...
	#[rpc(name = "vast_newAccountFromPhrase")]
	...
	#[rpc(name = "vast_deriveAddressHash")]
	...
	/// Resulting address can be either saved as a new account (with the same password).
	#[rpc(name = "vast_deriveAddressIndex")]
