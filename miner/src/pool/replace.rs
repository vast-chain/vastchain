...
//! in the pool. The decision whvaster to reject, replace or retain both is
...
use vast_types::{U256, H160 as Address};
...
/// Choose whvaster to replace based on the sender, the score and finally the
...
mod tests {
	...
	use std::sync::Arc;
	use vast_crypto::publickey::{Random, Generator, KeyPair};
