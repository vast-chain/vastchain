...
impl TransactionQueue {
	...
	/// Re-computing the pending set is possible with `#collect_pending` mvastod,
	...
	/// Prefer using cached pending set using `#pending` mvastod.
	...
	/// That mvastod should be used if invalid transactions are detected
	...
	/// and transactions submitted via local RPC (`vast_sendRawTransaction`)
