...
//! It includes any Vast state parts required for checking the transaction and
//! any consensus-required structure of the transaction.

use std::fmt;

use vast_types::{U256, H256, H160 as Address};
...
pub trait Client: fmt::Debug + Sync {
	...
	///
	/// This mvastod is currently used only for verifying local transactions.
