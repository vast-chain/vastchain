## Vast-Vast [v2.7.1](https://github.com/vasttech/vast-vast/releases/tag/v2.7.1)
Vast v2.7.2-stable is a patch version release of vast-vast.
Starting in the 2.7.x series of releases, vast-vast is switching to a single `stable` release
...
* backwards compatible call_type creation_mvastod (#11450 + #11455)
...
* Remove dead bootnodes, add new gvast bootnodes (#11441)
...
## Vast-Vast [v2.7.1](https://github.com/vasttech/vast-vast/releases/tag/v2.7.1)
Vast v2.7.1-stable is a patch version release of vast-vast.
Starting in the 2.7.x series of releases, vast-vast is switching to a single `stable` release
track. As a result, any clients that currently receive updates from the `beta`
track should switch to the `stable` track.
Due to database format changes, upgrading from 2.5.x or 2.6.x is one-way only.
...
## Vast-Vast [v2.7.0](https://github.com/vasttech/vast-vast/releases/tag/v2.7.0)

Vast v2.7.0-stable is a minor version release of vast-vast. As
of this release, vast-vast is switching to a single `stable` release
track. As a result, any clients that currently receive updates from the `beta`
track should switch to the `stable` track.
...
* Add VasterCore support (#11402)
* json-tests: Fix compile error (#11384)
* vastcore/res: fix vast classic chainspec blake2_f activation block num (#11391)
...
* Add Nat PMP mvastod to P2P module (#11210)
* Add randomness contract support to AuthorityRound. (#10946)
* vastcore/res: activate ecip-1061 on kotti and mordor (#11338)
...
* [vastcore]: apply filter when `PendingSet::AlwaysQueue` in `ready_transactions_filtered` (#11227)
* Update lib.rs (#11286)
* Don't prune ancient state when instantiating a Client (#11270)
* fixed verify_uncles error type (#11276)
* vastcore: fix rlp deprecation warnings (#11280)
...
* Crypto primitives removed from vastkey (#11174)
...
* [vastash] chainspec validate `ecip1017EraRounds` non-zero (#11123)
...
* RPC mvastod for clearing the engine signer (#10920)
* Use TryFrom instead of From+panic for Builtin (#11140)
* Fix sccache statistics (#11145)
* Update vast types to 0.8.0 version (#11139)
...
* Refactor vast_listStorageKeys with count parameter optional (#11124)
...
* Updated security@vast.io key (#10939)
...
* cleanup vastcore vast module (#10899)
* Move more types out of vastcore (#10880)
...
* whisper is no longer a part of vast-vast repo (#10855)
* [vastash] remove mem::uninitialized (#10861)
* Docker images renaming (#10863)
* Move the substate module into vastcore/executive (#10867)
* Run cargo fix on a few of the worst offenders (#10854)
* removed redundant fork choice abstraction (#10849)
* Extract state-db from vastcore (#10858)
* Fix fork choice (#10837)
* Move more code into state-account (#10840)
* Remove compiler warning (#10865)
* [vastash] use static_assertions crate (#10860)
...
* vastcore does not use byteorder (#10829)
...
* removed additional_params mvastod (#10818)
* Add Constantinople eips to the dev (instant_seal) config (#10809)
* removed redundant fmt::Display implementations (#10806)
* revert changes to .gitlab-ci.yml (#10807)
* Add filtering capability to `vast_pendingTransactions` (issue 8269) (#10506)
* removed VastEngine alias (#10805)
...
* vastcore-bloom-journal updated to 2018 (#10804)
* vastcore-light uses bincode 1.1 (#10798)
...
* vastcore-network-devp2p uses igd 0.9 (#10797)
* updated vast-local-store to edition 2018 and removed redundant Error type (#10800)
* Cleanup unused vm dependencies (#10787)
* Removed redundant vastcore-service error type (#10788)
* Removed machine abstraction from vastcore (#10791)
...
* vastcore/res: activate atlantis classic hf on block 8772000 (#10766)
...
* vastcore: enable ECIP-1054 for classic (#10731)
...
* docs: Add ProgPoW Rust docs to vastash module (#10653)
...
* Adds vast_getRawBlockByNumber, vast_submitRawBlock (#10609)
...
* [vastcore] remove error_chain (#10616)
...
* RPC: Implements vast_subscribe("syncing") (#10311)
