...
impl ServiceContract for OnChainServiceContractAggregate {
	...
	// in current implementation all publish mvastods are independent of actual contract adddress
	// (tx is sent to origin) => we do not care which contract to use for publish data in mvastods below
