...
pub type ServerKeyId = vast_types::H256;
/// Encrypted document key type.
pub type EncryptedDocumentKey = bytes::Bytes;
/// Message hash.
pub type MessageHash = vast_types::H256;
/// Message signature.
...
impl From<vast_types::Public> for Requester {
	fn from(public: vast_types::Public) -> Requester {
		Requester::Public(public)
	}
}

impl From<vast_types::Address> for Requester {
	fn from(address: vast_types::Address) -> Requester {
